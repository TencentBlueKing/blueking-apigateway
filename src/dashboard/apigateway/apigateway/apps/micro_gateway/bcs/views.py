...
class BcsViewSet(viewsets.ViewSet):
    ...
    def get_projects(self, request, *args, **kwargs):
        try:
            projects = BcsHelper(bk_ticket=get_user_bk_ticket_from_request(request)).get_projects()
        ...
        return OKJsonResponse(data=sorted(slz.data, key=operator.itemgetter("project_name")))
    ...
    def get_clusters(self, request, *args, **kwargs):
        ...
        try:
            clusters = BcsHelper(bk_ticket=get_user_bk_ticket_from_request(request)).get_clusters(
        ...
        return OKJsonResponse(data=sorted(slz.data, key=operator.itemgetter("cluster_id")))
    ...
    def get_namespaces(self, request, *args, **kwargs):
        ...
        try:
            namespaces = BcsHelper(bk_ticket=get_user_bk_ticket_from_request(request)).get_namespaces(
        ...
        return OKJsonResponse(data=sorted(slz.data, key=operator.itemgetter("namespace")))
    ...
    def get_releases(self, request, *args, **kwargs):
        ...
        try:
            releases = ReleaseHelper(bk_ticket=get_user_bk_ticket_from_request(request)).list_releases(
                project_id=data["project_id"],
                cluster_id=data["cluster_id"],
        ...
        return OKJsonResponse(data=sorted(slz.data, key=operator.itemgetter("release_name")))
