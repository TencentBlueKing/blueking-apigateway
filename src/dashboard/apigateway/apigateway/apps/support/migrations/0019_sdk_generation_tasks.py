# Generated by Django 5.2.15 on 2026-09-03 12:35
...
def migrate_gateway_sdk_language_forward(apps, schema_editor):
    gateway_sdk = apps.get_model("support", "GatewaySDK")
    gateway_sdk.objects.filter(language="golang").update(language="go")


def migrate_gateway_sdk_language_reverse(apps, schema_editor):
    gateway_sdk = apps.get_model("support", "GatewaySDK")
    gateway_sdk.objects.filter(language="go").update(language="golang")
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            migrate_gateway_sdk_language_forward,
            migrate_gateway_sdk_language_reverse,
        ),
        migrations.AlterField(
            model_name="gatewaysdk",
            name="language",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('python', 'Python'), ('java', 'Java'), ('go', 'Go'), ('javascript', 'Javascript')], max_length=32)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('running', 'Running'), ('success', 'Success'), ('failed', 'Failed')], db_index=True, default='pending', max_length=32)),
                ...
                ('native_lease_token', models.CharField(blank=True, db_index=True, default='', max_length=64)),
                ('native_lease_expires_at', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('native_next_attempt_at', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('native_error_code', models.CharField(blank=True, default='', max_length=64)),
                ('native_error_message', models.TextField(blank=True, default='')),
                ('gateway_sdk', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='generation_item', to='support.gatewaysdk')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('running', 'Running'), ('success', 'Success'), ('failed', 'Failed')], db_index=True, default='pending', max_length=32)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='artifacts', to='support.sdkgenerationitem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(blank=True, max_length=32, null=True)),
                ('updated_by', models.CharField(blank=True, max_length=32, null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('running', 'Running'), ('success', 'Success'), ('partial', 'Partial'), ('failed', 'Failed')], db_index=True, default='pending', max_length=32)),
                ('gateway', models.ForeignKey(db_column='api_id', on_delete=django.db.models.deletion.CASCADE, to='core.gateway')),
                ('resource_version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.resourceversion')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='support.sdkgenerationtask'),
        ),
