...
class TestProtoConvertor:
    ...
    def test_proto_convertor_initialization(self, mock_release_data):
        ...
        convertor = ProtoConvertor(mock_release_data, publish_id=123, apisix_version=APISIX_VERSION_3_13)
    ...
    def test_proto_convertor_with_custom_apisix_version(self, mock_release_data):
        ...
        convertor = ProtoConvertor(mock_release_data, publish_id=123, apisix_version=APISIX_VERSION_3_16)
