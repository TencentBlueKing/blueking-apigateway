...
class TestGatewayReleaser:
    ...
    def test_pre_release_prepares_oauth2_permissions(
        ...
        mock_oauth2_reconciler.prepare_publish.assert_called_once_with(
            fake_gateway,
            fake_stage,
    ...
    def test_pre_release_rejects_incompatible_oauth2_data_plane(
        ...
        mock_oauth2_reconciler.prepare_publish.assert_not_called()
