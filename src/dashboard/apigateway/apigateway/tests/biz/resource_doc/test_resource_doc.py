...
class TestResourceDocHandler:
    ...
    def test_get_docs(self, fake_resource):
        ...
        zh_doc = G(ResourceDoc, resource_id=fake_resource.id, gateway=fake_resource.api, language="zh")
        ...
        en_doc = G(ResourceDoc, resource_id=fake_resource.id, gateway=fake_resource.api, language="en")
        result = ResourceDocHandler.get_docs([fake_resource.id])
        assert result == {
            fake_resource.id: [
                {
