...
- 修复：mcp server 授权应用问题
- 修复：mcp server 权限申请接口返回 ID 问题
...
- 修复：MCP Server 协议版本校验
- 修复：可编程网关创建调用 paas 接口失败
- 修复：MCP Server 权限接口协议
...
- 修复：资源请求参数默认值回显
- 修复：下架旧版本资源校验失败
- 更新：OPEN API MCP server 权限申请接口响应协议
- 修复：一批样式问题
