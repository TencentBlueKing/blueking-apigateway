    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                default='version_publish',
                max_length=64,
            ),
        ),
        AddDefaultValue(model_name='releasehistory', name='source', value='version_publish'),
        migrations.AlterField(
            model_name='context',
            name='scope_type',
            field=models.CharField(
                choices=[('api', 'Gateway'), ('stage', 'Stage'), ('resource', 'Resource')],
                db_index=True,
                max_length=32,
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('stage_rate_limit', 'Stage rate limit'),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                db_column='api_id', on_delete=django.db.models.deletion.PROTECT, to='core.gateway'
            ),
        ),
        migrations.AlterField(
            model_name='microgatewayreleasehistory',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                choices=[
                    ('validata_configuration', 'validate configuration'),
                    ('generate_release_task', 'generate release task'),
                    ('distribute_configuration', 'distribute configuration'),
                    ('parse_configuration', 'parse configuration'),
