...
class Auditor:
    ...
    @staticmethod
    def record_mcp_server_op_success(
        op_type: OpTypeEnum,
        username: str,
        gateway_id: int,
        instance_id: int,
        ...
        if comment is None:
            comment = {
                OpTypeEnum.CREATE: "创建 MCPServer",
                OpTypeEnum.MODIFY: "更新 MCPServer",
                OpTypeEnum.DELETE: "删除 MCPServer",
            }.get(op_type, "-")
    ...
    @staticmethod
    def record_mcp_server_permission_op_success(
        op_type: OpTypeEnum,
        username: str,
        gateway_id: int,
        instance_id: int,
        ...
        if comment is None:
            comment = {
                OpTypeEnum.CREATE: "创建 MCPServer 应用权限",
                OpTypeEnum.MODIFY: "更新 MCPServer 应用权限",
                OpTypeEnum.DELETE: "删除 MCPServer 应用权限",
            }.get(op_type, "-")
