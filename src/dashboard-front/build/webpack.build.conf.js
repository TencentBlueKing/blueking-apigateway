...
const prodConf = merge(baseConf, {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            NODE_ENV: config.build.env.NODE_ENV,
            LOCAL_DEV_URL: config.build.env.LOCAL_DEV_URL,
            LOCAL_DEV_PORT: config.build.env.LOCAL_DEV_PORT,
            AJAX_MOCK_PARAM: config.build.env.AJAX_MOCK_PARAM
        }),
        ...
        new CopyWebpackPlugin([
            {
                ...
                ignore: ['js/bklogout-*.js', 'json/config-*.js', 'runtime/runtime-*.js']
            }
        ]),
