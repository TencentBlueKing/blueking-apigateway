...
export const getGatewayMetrics = (apigwId: number, params: IGatewaysMetricsQueryRangeListQuery) =>
  http.get<IMetricRangeOutput>(`${path}/${apigwId}/metrics/query-range/`, params, { catchError: true });

export const getGatewayMetricsInstant = (apigwId: number, params: IGatewaysMetricsQueryInstantListQuery) =>
