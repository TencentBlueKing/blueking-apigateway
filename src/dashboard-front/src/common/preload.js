...
function getApisList () {
  if (store.state.apis.apigwList.length) {
    return store.state.apis.apigwList
  }
  return store.dispatch('apis/getApisList')
}

function getUserAuthType () {
  if (store.state.userAuthType.length) {
    return store.state.userAuthType
  }
  return store.dispatch('getUserAuthType')
}
