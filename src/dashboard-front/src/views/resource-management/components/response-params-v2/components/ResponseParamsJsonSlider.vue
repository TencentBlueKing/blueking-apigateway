...
<template>
  <AgSideSlider
    ...
    render-directive="if"
  >
    <div class="response-params-json-slider">
      <div class="response-params-json-slider__actions">
        <IconButton
          icon="upload"
          theme="primary"
      ...
      <BkAlert
        class="response-params-json-slider__alert"
        theme="info"
        :title="t('请粘贴接口真实的响应体 JSON，或通过「导入 JSON」上传文件。内容可从接口文档、调试工具或实际调用结果中获取，系统将据此自动生成参数结构。')"
      />
    ...
    <template #footer>
      <div class="response-params-json-slider__footer">
        <BkButton
          class="w-88px mr-8px"
          theme="primary"
