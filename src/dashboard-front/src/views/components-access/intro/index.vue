...
const flowList = ref<any>([
  { text: t('编码具体组件逻辑'), tips: t('根据需求编码组件逻辑') },
  { text: t('注册系统'), tips: t('点击\'系统管理\'，注册组件所需系统') },
  { text: t('添加组件'), tips: t('点击\'组件管理\'，注册编码的组件信息') },
  { text: t('重启服务'), tips: t('按指令\'重启服务\'') },
  { text: t('完成'), tips: t('完成接入') },
]);
</script>
