<template>
  <div class="chart-wrapper">
    ...
    <div v-show="!isEmpty">
      <div class="line-chart" :id="instanceId">
      </div>
...
const getChartOption = () => {
  ...
  <p><span class="tooltip-icon">${params.marker}${t(props.title)}: </span><span>${params.data[1] !== null ? params.data[1].toLocaleString() : '0'} ${t('次')}</span></p>
  </div>`;
  };
