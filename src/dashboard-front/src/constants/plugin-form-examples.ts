...
allow_credential: false`,
  // bk-ip-restriction
  'bk-ip-restriction': `作用：仅允许 IP 192.168.1.1 和 192.168.1.1 请求当前接口
...
"rejected_msg": "not valid request body"`,
  // api-breaker
  'api-breaker': `Purpose: When the backend service returns a status code of 502 and this happens 3 times, a circuit breaker is triggered. It will return a response body with "hello world", a status code of 502, and a response header of foo:bar.
...
allow_credential: false`,
  // bk-ip-restriction
  'bk-ip-restriction': `Purpose: Only IP 192.168.1.1 and 192.168.1.1 are allowed to request the current interface
