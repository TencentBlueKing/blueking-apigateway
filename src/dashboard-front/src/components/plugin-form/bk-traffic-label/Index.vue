    ...
    <BkFormItem property="match">
      <template #label>
        <div class="flex justify-between items-center">
          <div>{{ t('染色条件') }}<span class="pl-4px color-#ea3636">*</span></div>
          <div class="flex items-center">
            ...
            >
              ...
              >
                <BkRadioButton
                  v-bk-tooltips="t('满足全部条件')"
                  label="AND"
                >
                  AND
                </BkRadioButton>
                <BkRadioButton
                  v-bk-tooltips="t('满足任意条件')"
                  label="OR"
                >
                  OR
                </BkRadioButton>
