...
const TimelineViewingLayerProps = {
  boundsInvalidator: { type: Number as PropType<any | null | undefined> },
  ...
  viewRangeTime: { type: Object as PropType<IViewRangeTime> },
};
...
type TOutOfViewLayout = { isOutOfView: true };
