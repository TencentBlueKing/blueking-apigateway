...
<script>
  ...
  export default {
    ...
    created () {
      this.defaultPlaceholder = this.placeholder || this.$t('请输入用户')
    ...
    methods: {
      ...
      requestList () {
        ...
        const prefix = host.indexOf(`.${window.GLOBAL_CONFIG.IED_DOMAIN}`) > -1
          ? `${protocol}//o.${window.GLOBAL_CONFIG.IED_DOMAIN}/component/compapi/tof3/`
        ...
        if (this.type === 'rtx') {
          template = (
                            <div class={parentClass}>
                                <img class={avatarClass} src={`//dayu.${window.GLOBAL_CONFIG.WOA_DOMAIN}/avatars/${node.english_name}/avatar.jpg`} />
      ...
      tpl (node, ctx, highlightKeyword) {
        ...
        switch (this.type) {
          case 'rtx':
            ...
            template = (
                            <div class={parentClass}>
                                <img class={imgClass} src={`//dayu.${window.GLOBAL_CONFIG.WOA_DOMAIN}/avatars/${node.english_name}/avatar.jpg`} />
                                <span
                                    class={textClass}
