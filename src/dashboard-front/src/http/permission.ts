 ...
 * @param data 参数
 */
export const updateApigwPermissionStatus = (apigwId: number, data: any) => fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-permission-apply/approval/`, data);
 ...
 * @param data 查询参数
 */
export const getApigwPermissionApplyList = (apigwId: number, data: any) => fetch.get(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-permission-apply/?${json2Query(data)}`);
 ...
 * @param data 参数
 */
export const gatewayPermissionsRenew = (apigwId: number, data: any) => fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-gateway-permissions/renew/`, data);
 ...
 * @param data 参数
 */
export const resourcePermissionsRenew = (apigwId: number, data: any) => fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-resource-permissions/renew/`, data);
 ...
 * @param data 删除参数
 */
export const gatewayPermissionsDelete = (apigwId: number, data: any) => fetch.delete(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-gateway-permissions/delete/`, data);
 ...
 * @param data 删除参数
 */
export const resourcePermissionsDelete = (apigwId: number, data: any) => fetch.delete(`${BK_DASHBOARD_URL}/gateways/${apigwId}/app-resource-permissions/delete/`, data);
 ...
 * @param data 参数
 */
export const gatewayPermissions = (apigwId: number, data: any) => fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-gateway-permissions/`, data);
 ...
 * @param data 参数
 */
export const resourcePermissions = (apigwId: number, data: any) => fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-resource-permissions/`, data);
 ...
 * @param data 查询参数
 */
export const getGatewayAppCodes = (apigwId: number, data: any) => fetch.get(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-gateway-permissions/bk-app-codes/?${json2Query(data)}`);
 ...
 * @param data 查询参数
 */
export const getResourceAppCodes = (apigwId: number, data: any) => fetch.get(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-resource-permissions/bk-app-codes/?${json2Query(data)}`);
 ...
 * @param data 查询参数
 */
export const getGatewayPermissions = (apigwId: number, data: any) => fetch.get(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-gateway-permissions/?${json2Query(data)}`);
 ...
 * @param data 查询参数
 */
export const getResourcePermissions = (apigwId: number, data: any) => fetch.get(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-resource-permissions/?${json2Query(data)}`);
 ...
 * @param data 查询参数
 */
export const getPermissionRecords = (apigwId: number, data: any) => fetch.get(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-permission-records/?${json2Query(data)}`);
 ...
 * @param data 导出参数
 */
export const gatewayPermissionsExport = async (apigwId: number, data: any) => {
  const res = await fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-gateway-permissions/export/`, data, { responseType: 'blob' });
  return blobDownLoad(res);
};
 ...
 * @param data 导出参数
 */
export const resourcePermissionsExport = async (apigwId: number, data: any) => {
  const res = await fetch.post(`${BK_DASHBOARD_URL}/gateways/${apigwId}/permissions/app-resource-permissions/export/`, data, { responseType: 'blob' });
  return blobDownLoad(res);
};
