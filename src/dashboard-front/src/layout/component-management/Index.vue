...
import { getComponentsMenu } from '@/constants';
import { useCommon, useGateway } from '@/stores';
import { useGateWayData } from '@/hooks';
...
const componentsMenu = ref(getComponentsMenu());

// 获取网关数据方法
const { getGatewaysListData } = useGateWayData(filterData);
