...
func (m *MockAppPermissionService) Query(ctx context.Context, gatewayName, stageName, resourceName, appCode string) (map[string]int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Query", ctx, gatewayName, stageName, resourceName, appCode)
...
func (mr *MockAppPermissionServiceMockRecorder) Query(ctx, gatewayName, stageName, resourceName, appCode interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Query", reflect.TypeOf((*MockAppPermissionService)(nil).Query), ctx, gatewayName, stageName, resourceName, appCode)
}
