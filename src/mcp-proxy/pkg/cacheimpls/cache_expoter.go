...
// GetMCPServerExtendCache ...
func GetMCPServerExtendCache() memory.Cache { return mcpServerExtendCache }

// SetMCPServerExtendCache ...
func SetMCPServerExtendCache(c memory.Cache) { mcpServerExtendCache = c }
